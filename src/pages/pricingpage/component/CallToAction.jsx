    ...
    <div className="bg-black text-white py-16 flex flex-col items-center">
      <div className="text-center">
        <h1 className="text-3xl md:text-4xl font-bold">
          ...
          do it in <span className="text-red-600">4Rays</span>
        </h1>
      </div>
      <div className="mt-8 flex gap-4">
        <button className="bg-red-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-red-700 transition duration-300">
          GET STARTED
        </button>
