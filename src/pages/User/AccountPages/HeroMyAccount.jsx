  ...
  return (
    <div className="mt-10 px-44 grid grid-cols-12 gap-8 justify-between">
      ...
      <div className="col-span-6 flex flex-col items-center gap-6 px-12 relative">
        ...
        <div className="absolute top-0 -mt-10 z-20 bg-[#ffff] ml-40"> {/* Adjust -mt-12 as needed */}
          <MyAccount />
        </div>

        {/* Image Section */}
        <div className="relative w-full flex flex-col items-center">
          <img src={mobile} alt="Mobile" className="w-72 h-auto -mt-8" /> {/* Adjust -mt-20 as needed */}
